    ...
    >
      <div className="flex flex-col  items-center text-center h-screen px-4">
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          ...
          <button className="px-8 py-3 bg-orange-700 text-white font-semibold rounded-lg hover:bg-orange-800 transition duration-300 border-2 border-white"onClick={()=>navigate("/contact")}>
            Contact Us
          </button>
        </div>
